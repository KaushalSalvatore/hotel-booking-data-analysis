...
-- sequence matter in creaeting table in snowflake using csv
CREATE TABLE BRONZE_HOTEL_BOOKING (
    booking_id STRING,
    hotel_id STRING,
    hotel_city STRING,
...
-- checking check out date should be after Check In 
SELECT check_in_date, check_out_date
FROM BRONZE_HOTEL_BOOKING
WHERE TRY_TO_DATE(check_out_date) < TRY_TO_DATE(check_in_date);

-- check spelling of booking_status 
...
-- Create Gold Tables 
-- Total booking and total revenue 
...
-- top cities according to revenue
...
-- all information for other chart 
